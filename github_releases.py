...
# First draft of a script to upload new official releases to github. Feature requests and modifications welcome.
# The functionality here should be merged with existing official releases scripts and be rewritten as necessary.
# It assumes the release files such as boost_1_76_0.tar.gz have already been generated, and are available in the current working directory.
#
